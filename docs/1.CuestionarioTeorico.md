...
- [X] **c) Contenerizar aplicaciones para que se ejecuten de forma consistente en distintos entornos**
...
- [X] **b) Mapea los puertos del contenedor a los del host**
...
- [X] **b) Docker Compose puede definir y ejecutar múltiples contenedores juntos.**
...
- [X] **c) Garantiza que las aplicaciones funcionen igual en cualquier entorno**
...
**2️⃣ ¿Para qué se utilizan volúmenes en Docker?** Se utilizan para persistir datos fuera de la vida del contenedor, por ejemplo, datos de una base de datos. 

**3️⃣ ¿Qué hace la instrucción `EXPOSE` en un Dockerfile?** Indica qué puerto usa o escucha la aplicación dentro del contenedor. 

**4️⃣ Escribe un beneficio de usar Docker en tus proyectos.** Facilita que la aplicación se ejecute igual en distintos entornos, reduciendo la aparición de problemas de “en mi máquina funciona”.
